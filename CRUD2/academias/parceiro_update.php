...
$idAcademia = filter_input(INPUT_POST,'id', FILTER_SANITIZE_NUMBER_INT)?? 0;
...
var_dump($idAcademia, $nome, $cnpj, $horarios, $bairro, $modalidades, $valores);

$dao = new AcademiaDAO();
$result = $dao->update($idAcademia, $nome, $cnpj, $horarios, $modalidades, $valores, $cep, $bairro, $complemento, $numero);

if ($result) {
    header('location:../view/parceiro_list.php?msg=Academia atualizada com sucesso!');
} else {
